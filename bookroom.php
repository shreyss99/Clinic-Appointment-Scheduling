...
<div class="bgimg-1 w3-opacity w3-display-container">
  <div class="w3-display-middle" style="white-space:nowrap;">
    <span class="w3-center w3-padding-xlarge w3-black w3-xlarge w3-wide w3-animate-opacity">BOOK<span class="w3-hide-small">  APPOINTMENT</span> </span>
  </div>
</div>
...
<ul class="w3-card-16 w3-ul w3-hoverable">
  ...
  <form name ="book" method="post" action="availability.php">
        ...
        <p><b>Doctor Name:</b><br><input type="radio" name="roomtype" value="deluxe"><br>
        			<input type="radio" name="roomtype" value="superdeluxe"><br>
        			<input type="radio" name="roomtype" value="suite"><br>
        </p>
  </li>
  <li class="w3-padding-large">
  		<p><b>TimeSlot:</b><br><input type="radio" name="roomchoice" value="9-10">9:00 - 10:00<br>
        			<input type="radio" name="roomchoice" value="10-11">10:00 - 11:00<br>
					<input type="radio" name="roomchoice" value="11-12">11:00 - 12:00<br>
					<input type="radio" name="roomchoice" value="12-13">12:00 - 13:00<br>
					<input type="radio" name="roomchoice" value="17-18">17:00 - 18:00<br>
					<input type="radio" name="roomchoice" value="18-19">18:00 - 19:00<br>
					<input type="radio" name="roomchoice" value="19-20">19:00 - 20:00<br>
       	</p>
   </li>
   <li class="w3-padding-large">
