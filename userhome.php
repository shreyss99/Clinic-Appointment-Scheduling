...
<div class="w3-row w3-padding-32 w3-section">
  ...
  <p>
  <li class="w3-padding-xlarge w3-center w3-deep-purple"><a href="userhome.php" style="text-decoration: none">My Appointment</a></li>
  <li class="w3-padding-xlarge w3-center"><a href="bookroom.php" style="text-decoration: none">Book Appointment</a></li>
  <li class="w3-padding-xlarge w3-center"><a href="bookedhistory.php" style="text-decoration: none">Booked History</a></li>
  	...
  	<p class="w3-center"><em>Didn't book appointment yet? Head on to BOOK APPOINTMENT and get best services from our world class doctors !!!<em></p>
  	</div>
   </div>      
