<?php
  ...
  $sql = "SELECT * from room where Roomno=".(int)$roomno;
  $result=$mysqli->query($sql) or die("BOOM");
  $result=$result->fetch_assoc();
  $tariff=$result['Tariff'];
  $roomtype=$result['Type'];
  $roomchoice=$result['Choice'];
  $roomview=$result['View'];
...
<ul class="w3-card-16 w3-ul">
  ...
  <li class="w3-padding-large">
    <h3><i>Room is available.<br>Do you want to book the room?</i></h3>
  </li>
  <li class="w3-padding-large">
    <p class="uppercase">Room Tariff: <b>Rs.<?php echo $tariff ?></b><br></p>
    <p class="uppercase">Room Type: <b><?php echo $roomtype ?></b><br></p>
    <p class="uppercase">Room Choice: <b><?php echo $roomchoice ?></b><br></p>
    <p class="uppercase">Room View: <b><?php echo $roomview ?></b><br></p>
  </li>
    </ul>
    <p>
    <button type="button" value="Cancel" class="w3-btn w3-left" onclick="location='bookroom.php'">Cancel</button>
    <button type="button" value="Book" class="w3-btn w3-right" onclick="location='payment.php'">Pay and Book >>></button>
    </p>
